...
au FileType rust setlocal shiftwidth=2 softtabstop=2 tabstop=2 expandtab
...
au FileType json setlocal shiftwidth=4 softtabstop=4 tabstop=4 expandtab
au FileType python setlocal shiftwidth=4 softtabstop=4 tabstop=8 expandtab
...
local servers = { 'solargraph', 'rust_analyzer', 'elixirls', 'gopls' }
